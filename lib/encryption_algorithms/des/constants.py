# The "Left" and "Right" halves of the table show which bits from the input key form the left and right
# sections of the key schedule state. Note that only 56 bits of the 64 bits of the input are selected;
